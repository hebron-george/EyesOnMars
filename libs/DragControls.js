...
THREE.DragControls = function(_camera, _objects, _domElement) {
    ...
    var _selected;
	this.domElement = ( _domElement !== undefined ) ? domElement : document;
    var me = this;
	


    me.domElement.addEventListener('mousemove', onDocumentMouseMove, false);
    me.domElement.addEventListener('mousedown', onDocumentMouseDown, false);
    me.domElement.addEventListener('mouseup', onDocumentMouseUp, false);
